...
type CreatePostPagesQueryQuery = { readonly allMdx: { readonly nodes: ReadonlyArray<{ readonly frontmatter: { readonly title: string | null, readonly slug: string | null } | null, readonly internal: { readonly contentFilePath: string | null } }> } };
